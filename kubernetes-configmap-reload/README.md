...
-------
    git clone https://github.com/vsupe358/spring-cloud-kubernetes.git
...
--------------
    docker build -t vsupe358/kubernetes-configmap-reload .
...
-----------
    docker push vsupe358/kubernetes-configmap-reload
